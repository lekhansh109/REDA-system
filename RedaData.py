...
class RedaData(Dataset):
    ...
    def __init__(self,dirname):
        ...
        print(item_len, user_len, self.datalen)
    ...
    def __getitem__(self, idx):
        ...
        sample = {
            'common_his_item': torch.LongTensor(common_his_item),
            'pos_item': torch.LongTensor([item]),
            'neg_item': torch.LongTensor(neg_item),
            "base_item": torch.LongTensor(base_item)}
    ...
    def getItems(self):
        return self.userset, self.itemset
